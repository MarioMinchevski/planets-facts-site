...
export function PlanetDesc({
    ...
    return (
        <div className="planet-desc">
            <div className="planet-desc__name-text-wrap">
                <motion.h2
                    className="planet-desc__name"
                >
                    {name}
                </motion.h2>
                <motion.p
